...
+ (instancetype)setup:(nullable id<RTC_OBJC_TYPE(RTCVideoEncoderFactory)>)encoderFactory
...
-(void)sendBuffer:(AudioBufferList)bufferList;
-(void)setAUCallback:(nullable void(*)(AudioBufferList *, UInt32))callbackParam sampleRateChangeCallbackParam:(nullable void(*)(float))sampleRateChangeCallbackParam;
