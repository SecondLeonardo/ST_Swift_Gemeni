...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Daily/Daily.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/HMSAnalyticsSDK/HMSAnalyticsSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/HMSSDK/HMSSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/HMSWebRTC/HMSWebRTC.framework"
